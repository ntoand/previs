...
Potree.Renderer = class Renderer {
	...
	renderOctree(octree, nodes, camera, target, params = {}){
		...
		{ // UPDATE UNIFORMS
			...
			shader.setUniform1i("elevationDirection", material.uniforms.elevationDirection.value);
...
Potree.PointCloudMaterial = class PointCloudMaterial extends THREE.RawShaderMaterial {
	constructor (parameters = {}) {
		...
		this.uniforms = {
			...
			elevationDirection:  { type: "i", value: 2 },
	...
	get elevationDirection() {
		return this.uniforms.elevationDirection;
	}
	
	set elevationDirection(value) {
		this.uniforms.elevationDirection.value = value;
	} 
	...
	render () {
		...
		{ // ATTRIBUTE PASS
			for (let pointcloud of viewer.scene.pointclouds) {
				...
				this.attributeMaterial.elevationDirection = material.elevationDirection;
	...
	render () {
		...
		{ // THREEJS
			...
			for (let [pointcloud, entry] of this.pointclouds) {
				...
				material.elevationDirection = pointcloud.material.elevationDirection;
